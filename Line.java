...
public class Line {
	...
	Point start = new Point(0, 0);// the position of children head
	Point end = new Point(0, 0);// the position of parent bottom
	int color = 0;
	...
	double x2 = 0;
	double y2 = 0;
	NodeLabel parent = null;
	NodeLabel children = null;
