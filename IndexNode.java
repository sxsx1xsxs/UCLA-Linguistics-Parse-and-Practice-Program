...
public class IndexNode extends DefaultMutableTreeNode {
		...
		public void updateTree(TreeMode.Tree treeInput) {
		...
		public IndexNode(TreeMode.Tree treeInput) {
		...
		public void outputTree(final JTextField sentenceString, final JTextField meaning, final Plain plain,
				Rectangle bounds) {
			System.out.println("st" + 25);
			System.out.println("here is the tree sent" + tree.sentence);
