...
import program.Interface.LUndoEdit;
...
public class Plain extends JLayeredPane {
	...
	public Point getLocation(int i) {
		System.out.println("pl"+9+"newly added");
	...
	class Top extends JPanel {
		...
		public void updateTP() {
			...
			// if existing, delete the same line
				...
				Line line=removelines(existed.parent, existed.children);
		...
		public void releaseDR(MouseEvent e) {
			...
			// clicked=4, moving nodes on drawroom
				...
				if(clicked==2||clicked==11){
					System.out.println("I am here to add nodes");
				...
				public void redo() throws javax.swing.undo.CannotRedoException
	               {
	                  super.redo();
	                  System.out.println("I am here for redo");
	                  remove(this.dl);
				...
				public void undo() throws javax.swing.undo.CannotUndoException
	               {
	                  super.undo();
	                  System.out.println("I am here for undo");
				...
				if(clicked==4){
					//System.out.println("I am here to add ");
